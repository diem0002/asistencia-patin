                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input required type="date" name="fecha_nacimiento" value={formData.fecha_nacimiento} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-casr-red focus:ring-casr-red sm:text-sm p-2 border" />
                                </div>
                                <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <input required type="tel" name="telefono_tutor" value={formData.telefono_tutor} onChange={handleChange} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-casr-red focus:ring-casr-red sm:text-sm p-2 border" />
                            </div>
